...
function MobileDashHeader() {
  ...
  return (
    <div className="MobileDashHeader">
      ...
      <Notification unreadNotifications={false} />
      {/* <NoNotification /> */}
...
function Notification({ unreadNotifications }) {
  return (
    ...
    >
      ...
      ></path>
      <path
        fill={unreadNotifications ? "red" : "none"}
        fillRule="evenodd"
        d={
          unreadNotifications
            ? "M19 1.25a3.75 3.75 0 1 0 0 7.5a3.75 3.75 0 0 0 0-7.5z"
            : "M19 1.25a3.75 3.75 0 1 0 0 7.5a3.75 3.75 0 0 0 0-7.5M16.75 5a2.25 2.25 0 1 1 4.5 0a2.25 2.25 0 0 1-4.5 0"
        }
        clipRule="evenodd"
      ></path>
      <path
